    ...
    <b-modal ref="class-modal" id="anotateDiaglog" title="Add a label" hide-footer>
        <b-form @submit="onSubmit" @reset="onReset">
            <b-container fluid class="bv-example-row">
                ...
                <p class="p-notice-color small">1.ตั้งชื่อด้วยตัวอักษรภาษาอังกฤษเท่านั้น เช่น a,b,c,A,B,C </p>
                <p class="p-notice-color small">2.ห้ามตั้งชื่อด้วยตัวเลข หรือ อักขระพิเศษ เช่น 1,2,3,-,/,(,),! </p>
                <p class="p-notice-color small">3.ห้ามเว้นวรรค และ ตั้งชื่อไม่เกิน 15 ตัวอักษร</p>
                <p class="p-notice-color small">4.ตั้งชื่อตามประเภทวัตถุ ชื่อเฉพาะของวัตถุ หรือ ชื่อสามัญทั่วไป เช่น dog, cat, flower, doraemon เป็นต้น</p>
                <b-form-row>
                    <b-col md="4">
