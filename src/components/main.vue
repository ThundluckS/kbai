    ...
    <b-modal id="modal-prevent-closing" ref="modal" title="Enter project name" @show="resetModal" @hidden="resetModal" @ok="handleOk">
        <form ref="form" @submit.stop.prevent="handleSubmit">
          ...
          " class="mode-select">
            ...
            <p class="p-notice-color small"> 2. ตั้งชื่อตามรูปแบบดังต่อไปนี้ <br><span class="p-color">ภาคตามด้วยรุ่นการอบรม_ชื่อโรงเรียน_ชื่อจริงของผู้เข้าอบรม</span></p>
            <p class="p-notice-color small"> ตัวอย่างการตั้งชื่อ เช่น </p>
            <p class="p-notice-color small"> ภาคเหนือ อบรมรุ่นที่ 1 ชื่อโรงเรียน SchoolName ชื่อผู้เข้าอบรม KidBright</p>
            <p class="p-notice-color small"> ตั้งชื่อโปรเจค: <span class="p-color">N1_SchoolName_KidBright</span></p>            
        </form>
    </b-modal>
